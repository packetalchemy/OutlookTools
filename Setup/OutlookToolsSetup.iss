...
[Run]
Filename: "{win}\Microsoft.NET\Framework64\v4.0.30319\regasm.exe"; Parameters: "/codebase /tlb ""{app}\OutlookTools.dll"""; StatusMsg: "Registering..."; Flags: runhidden waituntilterminated skipifdoesntexist
Filename: "{win}\Microsoft.NET\Framework\v4.0.30319\regasm.exe"; Parameters: "/codebase /tlb ""{app}\OutlookTools.dll"""; StatusMsg: "Registering..."; Flags: runhidden waituntilterminated skipifdoesntexist
